...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.lengyankanshijie.com.cn/', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '214a3c83b7c3800eaebceecc614749ea',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '冷鸟的歌迷', //
  BIO: process.env.NEXT_PUBLIC_BIO || 'Tingjia Zhang', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lengyankanshijie.com.cn/', // 网站地址
