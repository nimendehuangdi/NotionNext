...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tingjia Zhang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '冷眼看世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-wine-delta-91.vercel.app/', // 网站地址
